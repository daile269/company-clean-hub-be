...
public class WorkScheduleController {
    ...
    public ApiResponse<Boolean> hasPendingSchedules(@PathVariable Long employeeId) {
        boolean hasPending = workScheduleService.hasPendingSchedules(employeeId);
        return ApiResponse.success("OK", hasPending, HttpStatus.OK.value());
    }
