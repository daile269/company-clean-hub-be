...
public enum ErrorCode {
    ...
    PASSWORD_REQUIRED(400, "Mật khẩu bắt buộc"),
    ...
    INVALID_CCCD(400, "Số CCCD phải đúng 12 chữ số"),
    ...
    EMPLOYEE_ALREADY_WORKED(400, "Nhân viên này đã đi làm và chụp ảnh check-in, không thể thay thế"),
    ...
    QLV_CREATE_AFTER_ALLOWED_TIME(403,
            "QLV chỉ được phân công/điều động trong vòng 1 tiếng kể từ khi ca làm bắt đầu theo hợp đồng"),
